...
namespace Amber {
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseScrollEvent>(AM_BIND_EVENT_FN(ImGuiLayer::OnMouseScrollEvent));
		dispatcher.Dispatch<MouseMovementEvent>(AM_BIND_EVENT_FN(ImGuiLayer::OnMouseMoveEvent));
	...
	bool ImGuiLayer::OnMouseMoveEvent(MouseMovementEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
	...
	{
		ImGuiIO& io = ImGui::GetIO();
		io.DisplaySize = ImVec2(e.GetHeight(), e.GetWidth());
